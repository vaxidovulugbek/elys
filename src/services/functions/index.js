...
const apartmentStatusInPercent = (apartments) => {
	...
	const statuses_in_percent = {
		...
		status_not_for_sale: toFixed(100 / (apartments_count / statuses.status_not_for_sale), 2),
		status_construction: toFixed(100 / (apartments_count / statuses.status_construction), 2),
	};
